...
function doSearchDos() {
    const tableReg = document.getElementById('datosDos');
    const searchText = document.getElementById('searchTermDos').value.toLowerCase();
    let total = 0;
...
/*FUNCION DE BUSQUEDA 3--------------------------------------------- */
function doSearchTres() {
    const tableReg = document.getElementById('datosTres');
    const searchText = document.getElementById('searchTermTres').value.toLowerCase();
    let total = 0;
...
/*FUNCION DE BUSQUEDA 4--------------------------------------------- */
function doSearchCuatro() {
    const tableReg = document.getElementById('datosCuatro');
    const searchText = document.getElementById('searchTermCuatro').value.toLowerCase();
    let total = 0;
